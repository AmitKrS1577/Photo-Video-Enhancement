...
app_name   = "Photo-Video Enhancement"

app_name_color = "#FABC3F"
dark_color     = "#080808"
...
def upscale_video(
    ...
    if video_upscale_continue:
        ...
        print(f"Upscaling from scratch")
...
def show_error_message(exception: str) -> None:
    ...
    messageBox_subtitle = "Please report the error @ amitks1577@gmail.com"
    messageBox_text     = f"\n {str(exception)} \n"
...
def place_message_label():
    ...
    message_label.place(relx = column2_x, rely = row4_y - 0.025 , anchor = "center")
...
if __name__ == "__main__":
    ...
    info_message.set("Created by Amit & Anksuh")
